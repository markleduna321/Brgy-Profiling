                            ...
                            <tr key={profile.id}>
                                <td className="w-full max-w-0 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none sm:pl-0">
                                    ...
                                    <dl className="font-normal lg:hidden">
                                        ...
                                        <dd className="mt-1 truncate text-gray-500 sm:hidden">{profile.address}</dd>
                                    </dl>
                                </td>
                                <td className="hidden px-3 py-4 text-sm text-gray-500 lg:table-cell">{profile.contact_number}</td>
